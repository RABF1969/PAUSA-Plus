      ...
      `}>
        <div className="flex items-center gap-3 px-2 mb-10">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[10px] text-emerald-600 font-bold uppercase tracking-widest">Enterprise v2.0</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className={`px-3 py-2 text-[10px] font-black uppercase tracking-widest rounded-xl transition-all ${!location.pathname.startsWith('/kiosk')
                ...
                : 'bg-[var(--bg-accent)] text-[var(--text-secondary)] hover:bg-[var(--border-primary)]'
                }`}
            >
              Web Admin
            </button>
            <button
              ...
              className={`px-3 py-2 text-[10px] font-black uppercase tracking-widest rounded-xl transition-all ${location.pathname.startsWith('/kiosk')
                ...
                : 'bg-[var(--bg-accent)] text-[var(--text-secondary)] hover:text-emerald-600'
                }`}
            >
              Kiosk
            </button>
          ...
          <div className="pt-4 border-t border-[var(--border-primary)]">
            <div className="flex items-center gap-3 p-2 bg-[var(--bg-accent)] rounded-2xl border border-[var(--border-primary)]">
              ...
              <button
                ...
                className="flex size-8 items-center justify-center text-[var(--text-secondary)] hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-950/30 rounded-lg transition-all"
                title="Sair"
              >
