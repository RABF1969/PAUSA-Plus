...
import BreakTypeModal from './BreakTypeModal';

const BreakTypesSettings: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-[var(--bg-secondary)] p-6 rounded-[32px] border border-[var(--border-primary)]">
        <div>
          <h2 className="text-xl font-black text-[var(--text-primary)]">Tipos de Pausa</h2>
          <p className="text-sm text-[var(--text-secondary)]">Defina as regras e tempos limites</p>
        </div>
        <button
...
export default BreakTypesSettings;
